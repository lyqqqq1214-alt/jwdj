...
export type Page =
  | "login"
  | "admin-dashboard" | "admin-teachers" | "admin-courses" | "admin-users" | "admin-ai-ops" | "admin-audit" | "admin-config" | "admin-notification"
  ...
  | "ta-dashboard" | "ta-class" | "ta-import" | "ta-profile" | "ta-grading"
